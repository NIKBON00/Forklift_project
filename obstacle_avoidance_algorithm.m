...
% Distance to target based on EKF position estimation
distace_to_target = [EKFs{i}.x(1),EKFs{i}.x(2)] - target_considered;
...
error_theta = theta_ref - EKFs{i}.x(3);

% Calculation of linear speed, as proportional controller
...
% Caluclation of rotational speed, as proportional controller
